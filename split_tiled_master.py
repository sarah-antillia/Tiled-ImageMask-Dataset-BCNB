...
def split_tiled_master(images_dir, masks_dir, output_dir):
...
if __name__ == "__main__":
  try:
    images_dir = "./Tiled-BCNB-master/images/"
    masks_dir  = "./Tiled-BCNB-master/masks/"
    output_dir = "./Tiled-BCNB-ImageMask-Dataset/"
    if os.path.exists(output_dir):
      shutil.rmtree(output_dir)
    if not os.path.exists(output_dir):
      os.makedirs(output_dir)

    split_tiled_master(images_dir, masks_dir, output_dir)
